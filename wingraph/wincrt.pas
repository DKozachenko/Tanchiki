// "WinCrt Unit", Copyright (c) 2003-2008 by Stefan Berinde
//   Version: as WinGraph unit
//
// Source code: Free Pascal 2.2 (http://www.freepascal.org) &
//              Delphi 7
//
// Unit dependences:
//   windows  (standard)
...
implementation
uses windows{$IFDEF DELPHI},messages{$ENDIF},wingraph;
